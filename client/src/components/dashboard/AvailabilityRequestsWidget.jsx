...
export default function AvailabilityRequestsWidget() {
  const stats = [
    { label: "Pending", value: 0, icon: AlertCircle, color: "text-amber-500", bgColor: "bg-amber-500/20" },
    ...
    <div className="bg-[hsl(220,15%,14%)] border border-[hsl(220,15%,20%)] rounded-3xl overflow-hidden shadow-lg">
      ...
      <div className="bg-[hsl(220,15%,14%)] border-b border-[hsl(220,15%,20%)] px-5 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-bold text-gray-100">Availability Requests</h3>
        </div>
        <div className="flex items-center gap-2">
