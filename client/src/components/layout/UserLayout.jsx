  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <aside
        ...
        } w-64 lg:w-20 hover:lg:w-64 bg-white border-r border-gray-200 h-screen fixed lg:sticky top-0 flex flex-col shadow-sm transition-all duration-300 z-50 group`}
      >
        {/* Logo/Brand */}
